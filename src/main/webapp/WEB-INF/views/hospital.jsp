   ...
   $(function(){
      ...
      if (optionKeyword != null) {
          ...
          for (let i = 0; i < keywords.length; i++) {
              ...
              $(".optionKindText").each(function() {
                  if ($(this).text() === keywords[i].trim()) {
                      $(this).closest(".optionKind").addClass("cate-css");
         ...
         $(".optionKind").filter(function() {
            ...
            return false;
         }).addClass("cate-css").children(".xi-radiobox-blank").addClass("xi-check-circle").removeClass("xi-radiobox-blank");
      } else {
      ...
      $(document).on("click", ".selectByCategory", function(){
            ...
            $(".selectCategory").slideToggle("fast");
      });
      
      /* 유형 검색하기 */
      $(document).on("click", ".optionKind", function(){
         /* 유형값이 들어와있을 경우 */
         if ($(this).hasClass("cate-css")) {
            $(this).removeClass("cate-css");
         ...
         /* 유형 들어와있을 경우 버튼 활성화 */
         if( $(this).parent(".optionGroup").find(".cate-css").length > 0 ) {
             $(".optionSubmit").children().addClass("com-btn-css");
         } else {
        	 $(".optionSubmit").children().removeClass("com-btn-css");
         }
      });
      
      /* 유형 들어와있을 경우 버튼 활성화 */
      if( $(".cate-css").length > 0 ) {
          $(".optionSubmit").children().addClass("com-btn-css");
      } else {
     	 $(".optionSubmit").children().removeClass("com-btn-css");
      }
      ...
      $(document).on("click", ".optionSubmit", function(){
    	  if( $(".optionSubmit").children().hasClass("com-btn-css") ) {
