...
<body>
	...
	<div class="ham-container">
		...
		<c:choose>
				<c:when test="${sessionScope.mgrade eq 5 || sessionScope.mgrade eq 6 }">
				<div class="ham-menu">
				...
				<div class="ham-menuButton-doctor">
					<div class="ham-buttonImg-doctor">
						<img style="width: 70%" src="https://cdn-icons-png.flaticon.com/512/5996/5996051.png">
					</div>
					<div class="ham-noUser">
						<button onclick="link('docReception/${sessionScope.mno}/${sessionScope.dno}')" style="width: 133px;">비대면 진료 관리</button>
					</div>
				</div>
			</c:when>
			<c:when test="${sessionScope.mgrade eq 7 || sessionScope.mgrade eq 8 }">
				<div class="ham-menu">
					<div class="ham-userImg">
						<img src="https://cdn-icons-png.flaticon.com/512/6024/6024190.png">
					</div>
					<div class="ham-userInfo">
				...
				<div class="ham-menuButton-doctor">
					<div class="ham-buttonSubItem-admin">
						<div class="ham-buttonImg-doctor">
							<img style="width: 90%" src="https://cdn-icons-png.flaticon.com/512/9005/9005933.png">
						</div>
					...
					<div class="ham-buttonSubItem-admin">
						<div class="ham-buttonImg-doctor">
							<img style="width: 90%" src="https://cdn-icons-png.flaticon.com/512/3280/3280979.png">
						</div>
						<div class="ham-admin-button">
			...
			<div class="ham-menuButton">
				...
				<div class="ham-buttonSubItem"
					...
					<div class="ham-buttonImg" style="background-color: #fce4e4">
						<img src="https://cdn-icons-png.flaticon.com/512/881/881760.png ">
					</div>
				...
				<div class="ham-buttonSubItem"
					...
					<div class="ham-buttonImg" style="background-color: #EDF3FD">
						<img src="https://cdn-icons-png.flaticon.com/512/2674/2674841.png">
					</div>
