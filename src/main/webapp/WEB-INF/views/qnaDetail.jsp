...
<body>
				...
				<c:if test="${qnaQuestion.mno eq mno}">
					<form id="requestEditForm" action="/editQna" method="POST">
						<input type="hidden" name="bno" id="bno"
							value="${qnaQuestion.bno}"> <input type="hidden"
							name="btitle" id="btitle" value="${qnaQuestion.btitle}">
						<input type="hidden" name="bcontent" id="bcontent"
							value="${qnaQuestion.bcontent}"> <input type="hidden"
							name="dpkind" id="dpkind" value="${qnaQuestion.dpkind}">
						<button class="xi-pen-o xi-x" id="editButton"></button>
					</form>
				</c:if>

				<c:if test="${qnaQuestion.mno eq mno}">
					<form action="deleteQnaQuestion" method="post"
						id="deleteQnaQuestion">
						<input type="hidden" name="bno" id="bno"
							value="${qnaQuestion.bno}"> <i class="xi-trash-o xi-x"
							id="deleteButton" class="bdelete" onclick="deleteConfirm()"></i>
					</form>
				</c:if>
			</div>
	...
	<script>
		...
		const answerToggleButton = document
				.getElementById('answerToggleButton');
