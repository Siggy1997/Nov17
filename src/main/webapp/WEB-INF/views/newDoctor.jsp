...
<header>
	...
	<div>
		<h3 style="width: 110px; text-align: center; margin-left: 80px;">의사
			등록</h3>
	</div>
		...
		<div class="article">
			...
			<form action="/completeHosDoc" class="GroupCenter" method="post">
				...
				<div class="Group">
					...
					<div class="gender">
						<div class="man">
							<input type="radio" id="rdgender" name="rdgender" value="0"
								checked>남성
						</div>
						<div class="woman">
				...
				<div class="Group">
					<div class="vector"
						...
						여부</div>
					<input type="checkbox" id="rdspecialist" name="rdspecialist"
						class="cm-toggle">
				...
				<input class="vector" type="hidden" placeholder="병원번호" name="rhno"
					id="checkRhno" value="${rhnoDoctor.rhno }"> <input
					class="vector" type="hidden" placeholder="병원이름" name="rhname"
					value="${rhnoDoctor.rhname }">
				<div class="Group">
					<div class="vector"
						style="text-align: left; margin-left: 100px; font-size: 13px; color: gray; text-decoration: underline;">비대면진료
						여부</div>
					<input type="checkbox" id="rdtelehealth" name="rdtelehealth"
						class="cm-toggle">
